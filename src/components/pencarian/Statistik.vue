                        ...
                        <div class="content full-height borderless kolom2 mb-3">
                            ...
                            <div class="desc">
                                ...
                                <span class="date-time">
                                    ...
                                    LITBANG KOMPAS, {{ statistik.published_date ? this.$store.state.Tools.ChangeDateString(statistik.published_date.substring(0, 10)) : this.$store.state.Tools.ChangeDateString(statistik.published_date.substring(0, 10)) }}
                                </span>
                            </div>
                        </div>
                    </div>
                    <div v-if="currentTabs === 'all'" class="mt-3 d-flex justify-content-center">
                        <a v-on:click="changeScreen" class="btn btn-second">Data lainnya</a>
                    </div>
                </div>
            </div>
        </div>
