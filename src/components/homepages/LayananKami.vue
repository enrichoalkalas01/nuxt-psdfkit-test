                        ...
                        <div class="col-12 col-md-12 col-lg-4 my-2">
                            <a href="/layanan#riset" class="layanan-card">
                                ...
                                <p>
                                    ...
                                    dilengkapi dengan hasil grafik visual yang mudah dipahami.
                                </p>
                            </a>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4 my-2">
                            <a href="/layanan#konten" class="layanan-card">
                                ...
                                <p>
                                    ...
                                    berupa teks, visual grafis, audio maupun video sesuai kebutuhan.
                                </p>
                            </a>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4 my-2">
                            <a href="/layanan#penerbit" class="layanan-card">
                                ...
                                <p>
                                    ...
                                    Kami membantu menyusun tulisan-tulisan Anda dalam bentuk buku agar sesuai dengan kebutuhan pembaca.
                                </p>
                            </a>
                        </div>
                    </div>
