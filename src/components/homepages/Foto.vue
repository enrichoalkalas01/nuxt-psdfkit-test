        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-md-8 text-center mb-3">
                    ...
                    <h2 class="headtitle py-2">{{ fotos.title_section }}</h2>
                </div>
                <div class="row my-3">
                    <FotoCard
                        ...
                        v-bind:dataDate="foto.created_date"
                    />
                </div>
                <div class="col-12 mt-4 text-center text-md-end">
                    <a href="/pencarian?query=&subject=&datefrom=&dateto=&author=&publication=&typesearch=2&size=10&collection=&page=&currentpage=1&orderdirection=desc" class="more-link">Foto Lainnya <i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
    </section>
