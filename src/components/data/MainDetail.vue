        ...
        data () {
            return {
                ...
                ConfigApi: {
                    ...
                    url: `${ this.$store.state.Headers.BaseUrlApi }/api/data/` + this.$route.params.id + `/` + this.$route.params.collection,
                },
                dataSuggestions: null,
                ConfigApiSuggestion: { url: `${ this.$store.state.Headers.BaseUrlApi }/api/Configs/mainpage/data?count=3` },
            }
        },
