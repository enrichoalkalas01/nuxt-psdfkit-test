<template>
    <section>
        <div class="anchor" id="tentang"></div>
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 my-3">
                ...
                <div class="content borderless">
                    <h3 class="subtitle">Siapa Kami</h3>
                    <ol class="list-num">
                        <li>Merupakan data dan informasi yang telah dipublikasikan oleh Harian Kompas sebagai media massa terkemuka di Indonesia. </li>
                        <li>Data dan Informasi yang tersedia berasal dari sumber yang valid dan dapat dipertanggungjawabkan.</li>
                        <li>Kelengkapan data terkumpul sejak awal Harian Kompas berdiri sejak publikasi pertama tahun 1965 hingga topik terkini.</li>
                    </ol>
                </div>
            </div>
        </div>
