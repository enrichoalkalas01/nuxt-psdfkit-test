                    ...
                    <div class="nb-inner">
                        ...
                        <div class="user-box">
                            ...
                            <div class="wrapper-user" v-if="!this.$store.state.Login.LoginStatus">
                                <!-- <a href="https://account.kompas.id/login?next=http://data-dev.kompas.id/test" class="btn btn-line m-2" id="login">LOGIN</a> -->
                                <a href="https://account.kompas.id/login?next=http://data-dev.kompas.id/login-sso" class="btn btn-line m-2" id="login">LOGIN</a>
